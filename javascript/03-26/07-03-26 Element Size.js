...
function getElementSize(windowSize, elementVw, elementVh) {
    const windowWidthHeight = windowSize.split(" x ");
    const elementWidth = windowWidthHeight[0] / 100 * elementVw.slice(0, -2);
    const elementHeight = windowWidthHeight[1] / 100 * elementVh.slice(0, -2);
