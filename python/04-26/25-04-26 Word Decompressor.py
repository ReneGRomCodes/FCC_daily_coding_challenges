...
def decompress(s: str) -> str:
    ...
    decompressed_s: list[str] = []

    for item in s_list:
        if item.isnumeric():
            decompressed_s.append(s_list[int(item) - 1])
        else:
            decompressed_s.append(item)

    return " ".join(decompressed_s)
...
print(decompress("lorem ipsum dolor sit per elit donec 4 nostra libero 5 7 ligula 4 gravida at 6 vitae a 6 sodales 7 en "
                 "7 16 3 nam 13 dignissim risus 16 13 5 27 2 2 15 23 6 5 2 13 23 15 5 21 4 16 27 1 4 5 10 23 2 6 4 21 4 "
                 "30 6 30 2 6 16 15 18 23 29 27 4 18 sollicitudin 5 9 5 4 10"))
